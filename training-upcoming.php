...
<!-- Info part Start here -->
<section class="full-info-part">
	<div class="container">
		<div class="row">
		...
		<div class="row">
			<div class="col-md-12">
				<div class="info-part-text">
					<!-- Single Training Start Here -->
					<div class="single-training d-flex align-items-center">
					...
					<div class="jpg-pagination d-flex justify-content-end">
					...
					<h4><a href="training-previous.php" target="_blank">Previous Trainings</a></h4>
